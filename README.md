# genpark-ai-devops-workspace-canary-release-gate-skill
...
> **GenPark AI Agent Skill** -- AI DevOps workspace evaluating canary deployments against live telemetry metrics (Nuphos style)
